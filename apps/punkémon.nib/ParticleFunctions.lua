...
function slashDraw(p)
    fill_circ(p.position.x, p.position.y, p.size, p.color)
end
...
function bubbleDraw(particle)
    custom_sprite(particle.position.x, particle.position.y, 176, 16, 16, 16)
end
...
function sparklesDraw(particle)
    ...
    put_pixel(particle.position.x    , particle.position.y    , c)
    put_pixel(particle.position.x - 1, particle.position.y    , c)
    put_pixel(particle.position.x + 1, particle.position.y    , c)
    put_pixel(particle.position.x    , particle.position.y - 1, c)
    put_pixel(particle.position.x    , particle.position.y + 1, c)
end
